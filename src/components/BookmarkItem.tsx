...
import { ExternalLink, Edit, Trash2, Link } from 'lucide-react';
...
export function BookmarkItem({ bookmark, onEdit, onDelete, className }: BookmarkItemProps) {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.99 }}
    >
      <Card className={cn("relative p-3 hover:bg-accent/50 cursor-pointer group border transition-all duration-200", className)}>
